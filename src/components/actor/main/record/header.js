...
export default function ActorRecordHeader() {
    return (
        <RecordHeader>
            <HeaderItems>
                <Play style={{width: "32", height: "32", color: 'blue', margin: "0 6px"}}/>
                <Pause style={{width: "32", height: "32", color: 'lightgreen', margin: "0 6px"}} />
                <Stop color="deeppink" style={{width: "32", height: "32", margin: "0 6px"}} />
                <Backward style={{border: "1px", backgroundColor: "blue", width: "20", height: "32", borderRadius: "50%", color: 'white', margin: "0 6px", padding: "0 6px"}} />
                <Forward style={{border: "1px", backgroundColor: "blue", width: "20", height: "32", borderRadius: "50%", color: 'white', margin: "0 6px", padding: "0 6px"}} />
