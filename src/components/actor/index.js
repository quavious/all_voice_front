    ...
    return (
        <Container>
            ...
            <div style={{display: 'flex', maxWidth: "1215px", width: "100%", marginBottom: 70}}>
                ...
                <ActorMain widthLeft={widthLeft} setWidthLeft={setWidthLeft} widthMain={widthMain} widthMax={widthMax} setWidthMain={setWidthMain} widthRight={widthRight} setWidthRight={setWidthRight} />
